...
public class AlertFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_alert, container, false);

        Button mybtn_alert = vista.findViewById(R.id.btn_alert);

        mybtn_alert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder MyAlert = new AlertDialog.Builder(getActivity());
                MyAlert.setTitle("CLASE PMDM DAM2V");
