...
public class FragmentAdd extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EditText myEditTextDate = vista.findViewById(R.id.editTextDate);

        Spinner mySpinnerTipo = vista.findViewById(R.id.spTipo);
        Spinner mySpinnerModulo = vista.findViewById(R.id.spModulo);
        Spinner mySpinnerVigencia = vista.findViewById(R.id.spVigencia);
